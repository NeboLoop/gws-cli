...
| `gws-gmail-batch` | Bulk modify or delete messages |
| `gws-gmail-manage` | Mark read/unread, star, trash, delete, modify labels |
| `gws-gmail-threads` | Thread-level list, get, modify, trash, delete |
| `gws-gmail-labels` | Create, list, update, and delete labels |
| `gws-gmail-drafts` | Create, update, list, send, and delete drafts |
